...
Этот проект лицензирован под MIT License. Вы можете свободно использовать, изменять и распространять данный проект, при условии указания авторства. Проект предоставляется "КАК ЕСТЬ", автор не имеет любой вид ответсвенности, если у вас возникли проблемы после или во время использования продукта "ExcelOS".
